...
<div class="container-fluid">
			...
			<div class="card dashboard">
				<div class="card-body">
						...
						<marquee behavior="alternate" style="color:red; font-weight: 400; font-size: 16px;" scrolldelay="300">Alert : This Project is developed for Academic Study Purpose Only ! Don't Use for Commercial purpose without Permission of UDorn Sea.</marquee>
				</div>
